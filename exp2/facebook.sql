...
INSERT INTO `user` (`phonenumber`, `firstname`, `lastname`, `email`, `password`, `dob`, `address`) VALUES
...
--
ALTER TABLE `comments`
  MODIFY `comment_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61;
